...
2️⃣ Installation
Open your terminal or command prompt in the voice_ai_assistant directory.
...
🧠 Modules Work Flow
Wake Word triggers the assistant.
Speech-to-Text (STT) converts your voice to text.
Intent Detector & Entity Extractor figure out what operation you need.
If it's a conversation or knowledge question, AI Brain (Groq) handles it.
If it's an action, the Command Router tells the Automation Powerhouse to run it.
Text-to-Speech (TTS) responds to you with voice!
